...
The game features a **dynamic day and night cycle** that changes as the player progresses through the desert, creating a more immersive and evolving environment.

Players must also manage **health and fuel**, adding a survival element to the gameplay. The game ends when either **health reaches zero** due to collisions or **fuel runs out** during the journey.
...
Monitor **health and fuel levels** while progressing through the desert.  

Experience **day and night transitions** as the run continues.  

You **die when either health or fuel reaches zero**.
